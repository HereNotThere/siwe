...
exports.load = exports.pluginOptions = void 0;
...
function load(app) {
    ...
    const options = (0, exports.pluginOptions)(app);
...
function onPageRendered(page) {
    ...
    if (!options.hideGenerator && (options.footerLastModified || options.footerDate || options.footerTime)) {
        ...
        const script = options.footerLastModified
            ? (0, helpers_1.getLastModifiedScript)()
            : (0, helpers_1.getDateTimeScript)(options);
        ...
        page.contents = (0, helpers_1.appendToFooter)(page.contents, html);
    }
    // Set custom title.
